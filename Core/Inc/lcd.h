...
extern u32 POINT_COLOR;		//画笔颜色
extern u32 BACK_COLOR;  	//背景色
//LCD的画笔颜色和背景色
#define BIGWORD_REDCOLOR 0xF800		//FAIL颜色
...
#define DFT_SCAN_DIR  R2L_D2U  //默认的扫描方向　3从右到左,从上到下
...
void LCD_ShowString(u16 x,u16 y,u16 width,u16 height,u8 size,char *p,u8 mode);		//显示一个字符串,12/16字体
